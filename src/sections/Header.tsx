  ...
  const Logo = () => (
    <Link href="/">
      <div className="items-center block gap-1 row">
        <Image src="/images/logo.png" alt="Vivid logo" height="140" width="40" />
        <div className="text-3xl font-bold">
          <GradientText className="pink-blue"> Developer Castle</GradientText>
        </div>
      </div>
    </Link>
  );
    ...
    <nav>
      <ul className="items-center gap-2 row">
        ...
        <li className={`transition ${!nextSection && "hidden"}`}>
          <Button onClick={goToEmail}>Contact</Button>
        </li>
      </ul>
    </nav>
  );
